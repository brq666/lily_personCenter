...
public abstract class AbstractExcelExporter extends AbstractExcelView {
    ...
    Row createRowHeader(Sheet sheet, String... titles) {
    ...
    abstract void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook);

    RowBuilder createRow(Sheet sheet, int rowIndex) {
